...
export const metadata: Metadata = {
  title: 'Installation panneaux solaires photovoltaïques | Groupe Expert Altitude Com',
  description: 'Groupe Expert Altitude Com - Installation panneaux solaires photovoltaïques dans toutes nos zones d\'intervention. Devis gratuit.',
};
...
export default function PanneauxSolairesPage() {
  ...
  return (
    <main className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-6">Installation panneaux solaires photovoltaïques</h1>

      <section className="prose max-w-none mb-8">
        <p>
          Groupe Expert Altitude Com propose ses services de installation panneaux solaires photovoltaïques dans de nombreuses villes.
      ...
      <section className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {cities.map((city) => (
          <Link
            key={city.slug}
            href={`/services/panneaux-solaires/${city.slug}`}
