...
export const metadata: Metadata = {
  title: 'Travaux de zinguerie | Groupe Expert Altitude Com',
  description: 'Groupe Expert Altitude Com - Travaux de zinguerie dans toutes nos zones d\'intervention. Devis gratuit.',
};
...
export default function ZingueriePage() {
  ...
  return (
    <main className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-6">Travaux de zinguerie</h1>

      <section className="prose max-w-none mb-8">
        <p>
          Groupe Expert Altitude Com propose ses services de travaux de zinguerie dans de nombreuses villes.
      ...
      <section className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {cities.map((city) => (
          <Link
            key={city.slug}
            href={`/services/zinguerie/${city.slug}`}
