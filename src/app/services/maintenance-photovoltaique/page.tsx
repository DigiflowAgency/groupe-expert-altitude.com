...
export const metadata: Metadata = {
  title: 'Maintenance et nettoyage panneaux solaires | Groupe Expert Altitude Com',
  description: 'Groupe Expert Altitude Com - Maintenance et nettoyage panneaux solaires dans toutes nos zones d\'intervention. Devis gratuit.',
};

export default function MaintenancePhotovoltaiquePage() {
  const cities = [
  {
    "name": "Paris",
    "slug": "paris"
  ...
  return (
    <main className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-6">Maintenance et nettoyage panneaux solaires</h1>

      <section className="prose max-w-none mb-8">
        <p>
          Groupe Expert Altitude Com propose ses services de maintenance et nettoyage panneaux solaires dans de nombreuses villes.
      ...
      <section className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {cities.map((city) => (
          <Link
            key={city.slug}
            href={`/services/maintenance-photovoltaique/${city.slug}`}
