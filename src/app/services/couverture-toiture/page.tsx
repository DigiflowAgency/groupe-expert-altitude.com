...
export const metadata: Metadata = {
  title: 'Couverture et rénovation toiture | Groupe Expert Altitude Com',
  description: 'Groupe Expert Altitude Com - Couverture et rénovation toiture dans toutes nos zones d\'intervention. Devis gratuit.',
};

export default function CouvertureToiturePage() {
  const cities = [
  {
    "name": "Paris",
    "slug": "paris"
  ...
  return (
    <main className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-6">Couverture et rénovation toiture</h1>

      <section className="prose max-w-none mb-8">
        <p>
          Groupe Expert Altitude Com propose ses services de couverture et rénovation toiture dans de nombreuses villes.
      ...
      <section className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {cities.map((city) => (
          <Link
            key={city.slug}
            href={`/services/couverture-toiture/${city.slug}`}
