...
export const metadata: Metadata = {
  title: 'Gouttières et descentes pluviales | Groupe Expert Altitude Com',
  description: 'Groupe Expert Altitude Com - Gouttières et descentes pluviales dans toutes nos zones d\'intervention. Devis gratuit.',
};

export default function GouttierePage() {
  const cities = [
  {
    "name": "Paris",
    "slug": "paris"
  ...
  return (
    <main className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-6">Gouttières et descentes pluviales</h1>

      <section className="prose max-w-none mb-8">
        <p>
          Groupe Expert Altitude Com propose ses services de gouttières et descentes pluviales dans de nombreuses villes.
      ...
      <section className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {cities.map((city) => (
          <Link
            key={city.slug}
            href={`/services/gouttiere/${city.slug}`}
